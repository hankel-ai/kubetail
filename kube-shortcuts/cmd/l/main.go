...
func main() {
	if len(os.Args) > 1 {
		os.Exit(kubeutil.RunKubectlLogsWithRetry(logsArgs(50, os.Args[1:]...)...))
	}
	...
	case 0:
		...
		os.Exit(1)
	case 1:
		os.Exit(kubeutil.RunKubectlLogsWithRetry(logsArgs(50, pods[0])...))
	default:
		...
		os.Exit(kubeutil.RunKubectlLogsWithRetry(logsArgs(50, pod)...))
	}
}
